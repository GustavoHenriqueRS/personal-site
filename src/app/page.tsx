...
export default function Home() {
  ...
  const projectPaths = {
    project1: {
      ...
      name: "Vambora",
      about:
        "Aplicativo de caronas para universitários feito na disciplina de MDS, app feito em react-native e backend em node.js, minha principal contribuição foi no front-end do app, fui responsavel pela maior parte visual da aplicação",
      tecno: [
        "React-Native",
        "NodeJS",
        "Expo",
    ...
    project2: {
      ...
      name: "Mavi",
      about:
        "Aplicativo para rotas de ônibus, app feito em react-native usando styled-components para a parte visual, integração com o react-native-maps para a parte de mapas e integração com a api do google maps para a parte de rotas",
      tecno: [
        "React-Native",
        "Styled-Components",
        "Google Maps API",
    ...
    project3: {
      ...
      name: "O que precisa",
      about:
        "Solução Web para pessoas que querem oferecer serviços e pessoas que precisam de serviços, feito em react.js com tailwind, minha principal contribuição foi no front-end do app, fui responsavel pela maior parte visual da aplicação",
      tecno: [
        "React",
        "Tailwind",
        "Axios",
    ...
    project4: {
      ...
      about:
        "Solução Web do Governo Brasileiro para a participação popular, feito em Ruby e Ruby on Rails, minha principal contribuição foi no front-end do app, minha principal contribuição foi no front-end do app.",
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="text-white flex flex-col w-1/2 md:ml-14 py-8">
            ...
            <h2 className="text-3xl font-bold xl:text-5xl my-8">Tecnologias</h2>
            ...
            <p className="text-xs md:text-lg">
              Para aplicações mobile, este link levara para o repositorio. Ja
              aplicações Web levara para o site implementado.
            </p>
          </div>
        </div>
      </Modal>
    ...
    return (
      ...
      >
        ...
        <a href={sociaMedia[key as keyof typeof sociaMedia].link}>
          <FontAwesomeIcon
            size="3x"
            icon={sociaMedia[key as keyof typeof sociaMedia].icon as IconProp}
          />
        </a>
      </div>
    );
  ...
  return (
    <div className="bg-black flex w-full justify-between flex-col items-center md:gap-0">
      ...
      >
        <div className="text-white flex flex-col w-3/5 gap-4 ml-12">
          ...
          <motion.h3
            ...
            whileInView={characterAnimation.visible}
          >
            Tenho 21 anos, sou desenvolvedor Full-Stack Web e Mobile, sou
            estudante de Engenharia de Software na Universidade Federal de
            Brasilia e estou em busca de novos desafios.
          </motion.h3>
        </div>
        <motion.div
      ...
      >
        ...
        >
          <Image src={vin} alt="JulioCesar" width={600} height={600} />
        ...
        <div className="text-white flex-col h-1/2 flex justify-evenly w-1/2">
          ...
          >
            Como já mencionei anteriormente, meu nome é Gustavo, tenho 20 anos e
            estou atualmente no 7º semestre do curso de Engenharia de Software
            na Universidade Federal de Brasília. Meu foco atualmente está no
            desenvolvimento Full-Stack Web e Mobile, contando com alguns anos de
            experiência e projetos que você pode encontrar no meu GitHub.
          </motion.h2>
          <motion.h2
            initial={characterAnimation.hidden}
            whileInView={characterAnimation.visible}
          ...
          >
            ...
            considero-me uma pessoa proativa e honesta, sempre disposta a
            aprender e ensinar.
          </motion.h2>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-center flex-col">
          ...
          >
            ...
            me mandar um email ou me chamar no linkedin. Abaixo deixarei alguns
            links para você me conhecer melhor.
          </motion.h2>
